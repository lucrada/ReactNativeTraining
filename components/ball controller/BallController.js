...
export default function BallController() {
    ...
    return (
        <View>
            <View style={{ flex: 1, height: 700, justifyContent: "center", alignItems: "center" }}>
                <Animated.View style={{ backgroundColor: 'red', borderRadius: 50, width: 100, height: 100, marginBottom: y_cord, marginLeft: x_cord }}>
                </Animated.View>
            </View>
            <View style={{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center', marginBottom: 30, justifyContent: 'space-around' }}>
